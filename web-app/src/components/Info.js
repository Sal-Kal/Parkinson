...
export default function Info() {
  return (
    <div className="info">
      ...
      hand. Tremors are common, but the disorder may also cause stiffness or
      slowing of movement.
      <br />
      ...
      <ol>
        ...
        <li>
          Take a photo of your drawing using a smartphone or a digital camera.
        </li>
        <li>Save the photo on your computer or device.</li>
        <li>
          Upload the image by either clicking the upload button below or
          dragging and dropping the image in the drop area.
        </li>
        <li>Wait for the image to upload and for the test to complete.</li>
        <li>
          The test will show you a score between 0 and 100. If the score is
